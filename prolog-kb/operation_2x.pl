...
?- check_terminal_subject(hover_action_7). % false
...
?- check_default_observer(hover_action_4). % false
?- check_default_observer(hover_action_5). % false
?- check_default_observer(hover_action_6).
?- check_default_observer(hover_action_7). % false
